...
local StateWait     = require("script.50kScript.state.StateWait")
local StatePlaying  = require("script.50kScript.state.StatePlaying")
local StateClearing = require("script.50kScript.state.StateClearing")
-- 状态机
