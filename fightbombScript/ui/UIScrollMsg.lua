...
local SCROLL_BG_PATH = "ccbResources/fightbombRes/scroll_msg/scoll_bg.png"
local SCROLL_LABA_PATH = "ccbResources/fightbombRes/scroll_msg/laba2.png"
...
function UIScrollMsg:onShow()
    ...
    self.m_pSysScroll = require("script.fightbombScript.ui.ScollMessage").create()
