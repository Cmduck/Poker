...
local BG_IMG = "ccbResources/fightbombRes/trusteeship/trusteeship_back.png"
local BTN_IMG_1 = "ccbResources/fightbombRes/trusteeship/cancel_trusteeship.png"
local BTN_IMG_2 = "ccbResources/fightbombRes/trusteeship/cancel_trusteeship_n.png"
